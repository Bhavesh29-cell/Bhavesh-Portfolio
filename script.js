...
function openGmail() {
  const email = "bhaveshved2905@gmail.com";
...
function downloadCV() {
  ...
  link.href = "Bhavesh Ved Resume.pdf"; // Path to your resume file
  link.download = "Bhavesh Ved Resume"; // Name for the downloaded file
